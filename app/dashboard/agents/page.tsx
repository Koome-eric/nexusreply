    ...
    return (
      <div style={{ padding: "40px", maxWidth: "600px" }}>
        <div style={{ background: "rgba(13,21,37,0.9)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "16px", padding: "48px", textAlign: "center" }}>
          ...
          <a href="/dashboard/locations"><button style={{ padding: "11px 24px", borderRadius: "10px", border: "none", background: "linear-gradient(135deg,#0d9488,#14b8a6)", color: "white", fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>Connect GHL →</button></a>
        </div>
      </div>
    );
  }
